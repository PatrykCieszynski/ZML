...
from zml_game_bridge.inputs.ocr.pipelines.image import RelativeRect
from zml_game_bridge.inputs.ocr.pipelines.mining_finder.vision import FinderPanelLayout
