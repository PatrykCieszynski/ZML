...
export type AgentEventStreamOptions = {
    ...
    onEvent: (event: AgentEventEnvelope<string, unknown>) => void;
};
...
function toAgentEvent(message: SseMessage): AgentEventEnvelope<string, unknown> | null {
...
function parseAgentEvent(message: SseMessage): AgentEventEnvelope<string, unknown> | null {
    try {
