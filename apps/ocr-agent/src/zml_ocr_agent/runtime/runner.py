...
from zml_ocr_agent.pipelines.mining_finder.presence import FinderPresenceDetector
from zml_ocr_agent.pipelines.mining_finder.recording import (
    FinderCropRecorder,
    finder_recording_config_from_env,
)
from zml_ocr_agent.pipelines.mining_finder.vision import VisionFinderFeatureDetector
from zml_ocr_agent.pipelines.position.pipeline import PositionPipeline
from zml_ocr_agent.pipelines.position.recording import (
...
def _configure_finder_debug_logging() -> None:
    ...
    logging.getLogger("zml_ocr_agent.pipelines.mining_finder").setLevel(logging.DEBUG)
