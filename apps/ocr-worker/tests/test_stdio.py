...
from zml_ocr_worker.config import OcrRoiProfile
from zml_ocr_worker.runtime.message_factory import AgentMessageFactory
from zml_ocr_worker.runtime.stdio import AgentRuntimeState, ProtocolWriter, run_stdio
...
def test_stdio_applies_config_idempotently_rejects_stale_revision_and_shuts_down(
    ...
    monkeypatch.setattr(
        "zml_ocr_worker.runtime.stdio.preload_tesserocr_preserving_sigint_handler",
        lambda: None,
    )
    monkeypatch.setattr("zml_ocr_worker.runtime.stdio.start_ocr_input", fake_runner)
