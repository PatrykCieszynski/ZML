...
from zml_backend.application.mining import (
    MiningCoordinator,
...
from zml_backend.domain.mining import MiningMode
...
from zml_backend.domain.rate import percent
from zml_backend.inputs.chat.model import ChannelType
...
from zml_backend.persistence.mining_loot import (
    MiningLootItemRow,
    MiningLootTotalRow,
