...
from zml_backend.api.schemas.mining import (
    MiningClaimDto,
    MiningDropDto,
    MiningLootItemDto,
    MiningLootTotalDto,
...
from zml_backend.persistence.mining_drops import MiningDropReader
from zml_backend.persistence.mining_loot import MiningLootReader
