...
from zml_backend.api.routes import register_routes
from zml_backend.runtime.bootstrap import build_runtime_components, build_worker_supervisor
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="Z Mining Log Backend", version="0.1.0", lifespan=lifespan)
