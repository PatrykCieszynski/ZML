...
from zml_backend.paths import get_app_data_dir
...
def _default_ocr_worker_path() -> Path | None:
    return _env_path("ZML_OCR_WORKER_PATH")
...
class Settings:
    ...
    ocr_worker_path: Path | None = field(default_factory=_default_ocr_worker_path)
